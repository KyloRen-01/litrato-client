...
function PromoCard({ imageSrc, title, price, descriptions }: PromoCardProps) {
  return (
    <div className="flex flex-row gap-14 h-screen justify-center">
      <div className="flex flex-col rounded-t-xl w-[270px] max-h-[85vh] border-white shadow-neutral-200 shadow-md overflow-hidden">
        ...
        <div className="bg-[#1E1E1E] flex flex-col rounded-t-[48px] relative">
          <div className="p-2 bg-[#1E1E1E] rounded-t-4xl shadow-md shadow-black">
            <Image
              src={imageSrc}
              alt="display_img"
              width={100}
          ...
          <div className="absolute top-[100%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
            <div className="rounded-full bg-white shadow-black/50 shadow-md p-0.3">
              <div className="rounded-full p-4 bg-black w-12 h-12 flex items-center justify-center text-white text-xs font-semibold border-4 border-white">
                {price}
              </div>
            </div>
          </div>
