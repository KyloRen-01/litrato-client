...
import LitratoNavbar from "../../../components/Navbar";
import LitratoBranding from "../../../components/Branding";
import Datepicker from "../../../components/availability_picker";
import ImageSlider from "../../../components/Carousel";
import PromoCard from "../../../components/Service_Card";
    ...
    <div>
      ...
      <section id="home">
        <div className="relative h-56 w-full mb-6">
          ...
          <div className="absolute top-[-25] left-0 w-full h-full flex items-center justify-center z-10 gap-5 pl-48">
            ...
            <div
              ...
              className="absolute top-[60] right-60 bg-white font-semibold h-[45px] py-1 px-4 text-[20px] rounded-xl border-2 border-black hover:cursor-pointer shadow-md shadow-black"
            >
              Register
            </div>
          </div>
        ...
        <div className="flex justify-self-center items-center pt-12 gap-2">
          ...
          <div
            onClick={handleLogin}
            className="bg-black text-white px-4 py-2 rounded-lg hover:cursor-pointer font-bold"
          >
            LOGIN
          </div>
        </div>
      </section>
      <div className=" bg-[#8B0000] h-2 mt-5 "></div>
      <div className=" bg-[#ffd986] h-2"></div>
      <div className=" bg-[#8B0000] h-2"></div>
      {/* About section */}
      <section
        id="about"
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <div className="flex ml-24 bg-black text-white w-40 py-8 justify-center items-center h-10 rounded-lg hover:cursor-pointer">
            Explore More
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <div
            onClick={handleLogin}
            className="bg-black text-white w-1/2 py-3 text-center rounded-xl hover:cursor-pointer self-center mt-20 font-bold"
          >
            {" "}
            BOOK NOW{" "}
          </div>
